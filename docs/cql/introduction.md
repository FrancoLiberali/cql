...
| CQL | cql.Query[models.City]( <br>&emsp; context.Background(), <br>&emsp; db, <br>&emsp; conditions.City.Name.Is().Eq(cql.String("Paris")), <br>&emsp; conditions.City.Country( <br>&emsp;&emsp; conditions.Country.Name.Is().Eq(cql.String("France")), <br>&emsp; ), <br> ).FindOne() |
