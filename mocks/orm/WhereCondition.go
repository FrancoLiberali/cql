...
func (_m *WhereCondition[T]) ApplyTo(query *orm.Query, table orm.Table) error {
...
func (_m *WhereCondition[T]) GetSQL(query *orm.Query, table orm.Table) (string, []interface{}, error) {
	ret := _m.Called(query, table)

	var r0 string
	var r1 []interface{}
	var r2 error
	if rf, ok := ret.Get(0).(func(*orm.Query, orm.Table) (string, []interface{}, error)); ok {
	...
	if rf, ok := ret.Get(1).(func(*orm.Query, orm.Table) []interface{}); ok {
		r1 = rf(query, table)
	} else {
		if ret.Get(1) != nil {
	...
	if rf, ok := ret.Get(2).(func(*orm.Query, orm.Table) error); ok {
		r2 = rf(query, table)
	} else {
		r2 = ret.Error(2)
	}
