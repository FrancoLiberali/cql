...
func (_m *DynamicOperator[T]) ToSQL(query *orm.GormQuery, columnName string) (string, []interface{}, error) {
	ret := _m.Called(query, columnName)

	var r0 string
	var r1 []interface{}
	var r2 error
	if rf, ok := ret.Get(0).(func(*orm.GormQuery, string) (string, []interface{}, error)); ok {
		return rf(query, columnName)
	}
	if rf, ok := ret.Get(0).(func(*orm.GormQuery, string) string); ok {
		r0 = rf(query, columnName)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(*orm.GormQuery, string) []interface{}); ok {
	...
	if rf, ok := ret.Get(2).(func(*orm.GormQuery, string) error); ok {
