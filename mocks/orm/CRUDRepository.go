...
type CRUDRepository[T interface{}, ID orm.BadaasID] struct {
	mock.Mock
}
...
func (_m *CRUDRepository[T, ID]) Query(tx *gorm.DB, conditions ...orm.Condition[T]) ([]*T, error) {
...
func (_m *CRUDRepository[T, ID]) QueryOne(tx *gorm.DB, conditions ...orm.Condition[T]) (*T, error) {
	_va := make([]interface{}, len(conditions))
	for _i := range conditions {
		_va[_i] = conditions[_i]
	}
...
func NewCRUDRepository[T interface{}, ID orm.BadaasID](t mockConstructorTestingTNewCRUDRepository) *CRUDRepository[T, ID] {
