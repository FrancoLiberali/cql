...
type CRUDRepository[T orm.Model, ID orm.ModelID] struct {
	mock.Mock
}
...
func NewCRUDRepository[T orm.Model, ID orm.ModelID](t mockConstructorTestingTNewCRUDRepository) *CRUDRepository[T, ID] {
