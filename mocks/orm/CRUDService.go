...
type CRUDService[T model.Model, ID model.ID] struct {
	mock.Mock
}
...
func (_m *CRUDService[T, ID]) Query(conditions ...condition.Condition[T]) ([]*T, error) {
	...
	var r0 []*T
	var r1 error
	if rf, ok := ret.Get(0).(func(...condition.Condition[T]) ([]*T, error)); ok {
		return rf(conditions...)
	}
	if rf, ok := ret.Get(0).(func(...condition.Condition[T]) []*T); ok {
		r0 = rf(conditions...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*T)
	...
	if rf, ok := ret.Get(1).(func(...condition.Condition[T]) error); ok {
		r1 = rf(conditions...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *CRUDService[T, ID]) QueryOne(conditions ...condition.Condition[T]) (*T, error) {
	_va := make([]interface{}, len(conditions))
	for _i := range conditions {
		_va[_i] = conditions[_i]
	}
