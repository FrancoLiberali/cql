...
func Like[T string |
	...
	return orm.NewValueOperator[T](sql.Like, pattern)
}

// ref: https://dev.mysql.com/doc/refman/8.0/en/regexp.html#operator_regexp
func RegexP(pattern string) orm.Operator[string] {
	return orm.NewValueOperator[string](sql.MySQLRegexp, pattern)
}
