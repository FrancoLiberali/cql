...
func (condition invalidCondition[T]) ApplyTo(_ *query.Query, _ query.Table) error {
	return condition.Err
}

func (condition invalidCondition[T]) GetSQL(_ *query.Query, _ query.Table) (string, []any, error) {
